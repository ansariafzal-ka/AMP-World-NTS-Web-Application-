          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
              {helplineCategories.map((item) => (
                <div
                  key={item.phoneRaw}
                  className="flex flex-col justify-between rounded-2xl border border-zinc-200 bg-white p-6 sm:p-7 shadow-xs transition-all duration-300 hover:-translate-y-1 hover:border-[#610D17]/40 hover:shadow-md"
                >
                  <div>
                    ...
                    <h3 className="text-lg sm:text-xl font-bold text-zinc-900">{item.title}</h3>
                    <p className="text-xs font-medium text-zinc-500 mt-0.5">{item.subtitle}</p>

                    {/* Prominent Phone Display */}
                    <div className="mt-6 rounded-xl bg-zinc-50 p-4 border border-zinc-100 text-center">
                      <span className="block text-xs font-semibold uppercase tracking-wider text-zinc-500 mb-1">
                        Helpline Number
                      </span>
                      <a
                        href={`tel:${item.phoneRaw}`}
                        className="text-xl sm:text-2xl font-black text-zinc-900 tracking-tight transition-colors hover:text-[#610D17]"
                      >
                        {item.phoneRaw}
                      </a>
                  ...
                  <div className="mt-6 space-y-2.5 pt-4 border-t border-zinc-100">
                    <a
                      ...
                      className="flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-600 px-4 py-3 text-xs sm:text-sm font-bold text-white shadow-xs transition-all hover:bg-emerald-700 hover:shadow"
                    >
                    ...
                    <a
                      href={`tel:${item.phoneRaw}`}
                      className="flex w-full items-center justify-center gap-2 rounded-xl bg-zinc-100 px-4 py-2.5 text-xs sm:text-sm font-semibold text-zinc-700 transition-colors hover:bg-zinc-200"
                    >
